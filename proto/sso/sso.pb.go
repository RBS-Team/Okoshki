...
const file_sso_sso_proto_rawDesc = "" +
	...
	"\aIsAdmin\x12\x13.sso.IsAdminRequest\x1a\x14.sso.IsAdminResponseB-Z+github.com/RBS-Team/Okoshki/proto/sso;ssov1b\x06proto3"
...
var (
	file_sso_sso_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
	file_sso_sso_proto_goTypes  = []any{
